...
def cnn_inception(x):
    ...
    with tf.name_scope('inception1'):
        ...
        h_inception1 = tf.nn.relu(tf.concat([h_conv1_1x1_1, h_conv1_3x3, h_conv1_5x5, h_conv1_1x1_4], 3))
        
    with tf.name_scope('inception2'):
        #follows inception1
        W_conv2_1x1_1 = weight_variable([1, 1, 4*32, 64])
        b_conv2_1x1_1 = bias_variable([64])
        h_conv2_1x1_1 = conv2d(h_inception1,W_conv2_1x1_1)+b_conv2_1x1_1
     
        #follows inception1
        W_conv2_1x1_2 = weight_variable([1, 1, 4*32, 16])
        b_conv2_1x1_2 = bias_variable([16])
        h_conv2_1x1_2 = tf.nn.relu(conv2d(h_inception1,W_conv2_1x1_2)+b_conv2_1x1_2)
     
        #follows inception1
        W_conv2_1x1_3 = weight_variable([1, 1, 4*32, 16])
        b_conv2_1x1_3 = bias_variable([16])
        h_conv2_1x1_3 = tf.nn.relu(conv2d(h_inception1,W_conv2_1x1_3)+b_conv2_1x1_3)
        
        #follows 1x1_2
        W_conv2_3x3 = weight_variable([3, 3, 16, 64])
        b_conv2_3x3 = bias_variable([64])
        h_conv2_3x3 = conv2d(h_conv2_1x1_2,W_conv2_3x3)+b_conv2_3x3
        
        #follows 1x1_3
        W_conv2_5x5 = weight_variable([5, 5, 16, 64])
        b_conv2_5x5 = bias_variable([64])
        h_conv2_5x5 = conv2d(h_conv2_1x1_3,W_conv2_5x5)+b_conv2_5x5
        
        #follows inception1
        h_maxpool2 = max_pool_3x3(h_inception1)
        
        #follows max pooling
        W_conv2_1x1_4= weight_variable([1, 1, 4*32, 64])
        b_conv2_1x1_4= bias_variable([64])
        h_conv2_1x1_4 = conv2d(h_maxpool2,W_conv2_1x1_4)+b_conv2_1x1_4
        
        #concatenate the feature maps
        h_inception2 = tf.nn.relu(tf.concat([h_conv2_1x1_1, h_conv2_3x3, h_conv2_5x5, h_conv2_1x1_4], 3))
        
    # Fully connected layer 1 - after inception layer
    with tf.name_scope('fc1'):
        W_fc1 = weight_variable([28 *28 * 4*64, 1024])
        b_fc1 = bias_variable([1024])

        h_inception_flat = tf.reshape(h_inception2, [-1, 28*28*4*64])
