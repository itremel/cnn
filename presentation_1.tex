...
\author{Ivo Tremel und Lennard N\"{o}hren} % Your name
\institute[CHI] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Leibniz Universit\"{a}t Hannover \\ % Your institution for the title page
\medskip
...
\subsection{Convolution Layer} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
